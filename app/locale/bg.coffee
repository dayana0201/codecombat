module.exports = nativeDescription: "български език", englishDescription: "Bulgarian", translation:
  new_home:
    slogan: "Най-завладяващата игра да учиш програмиране."
    ...
    codecombat_is: "CodeCombat е платформа <strong>за ученици</strong> за изучаване на компютърни науки чрез игра."
    our_courses: "Нашите курсове са специално проверени за тяхното <strong>превъзходство в клас</strong>, дори от учители с малък или никакъв опит в програмирането."
    watch_how: "Гледайте как CodeCombat трансформира начина, по които хората се учат по компютърни науки.."
    ...
    getting_students: "Въвеждаме учениците чрез използване на типизиран код, колкото се може по-бързо, е ключово за научаването на програмния синтаксис и правилното структуриране."
    ...
    go_to_courses: "Отиди в курсовете"
  ...
  nav:
    ...
    my_classrooms: "Моите класни стаи"
    my_courses: "Моите курсове"
    careers: "Кариери"
    facebook: "Facebook"
    twitter: "Twitter"
    create_a_class: "Създайте клас"
    other: "Друг"
    learn_to_code: "Научете се да кодвате!"
    toggle_nav: "Превключване на навигация"
    schools: "Училища"
    ...
    copyright_suffix: "Всички права запазени"
    help_pref: "Нуждаете се от помощ? Имейл"
    help_suff: "и ние ще се свържем!"
    resource_hub: "Ресурсен център"
  ...
  diplomat_suggestion:
    title: "Помогни ни да преведем CodeCombat!" # This shows up when a player switches to a non-English language using the language selector.
  ...
  play:
    ...
    get_course_for_class: "Придайте разработка на игри и още повече за вашите класове!"
    request_licenses: "Свържете се с нашите училищни специалисти за подробности."
    ...
    subscribers_only: "Само абонирани!"
    subscribe_unlock: "Абонирайте се за да отключите!"
    subscriber_heroes: "Абонирайте се днес, за да отключите веднага Amara, Hushbaum и Hattori!"
    subscriber_gems: "Абонирайте се днес, за да купите този герой със скъпоценни камъни!"
    ...
    brain_pop_done: "Вие победихте човекоядците с код! Ти печелиш!"
    brain_pop_challenge: "Предизвикайте себе си, да играете отново с помощта на различни програмни езици!"
    replay: "Повтори"
    back_to_classroom: "Върни се в класната стая"
    teacher_button: "За учители"
    get_more_codecombat: "Вземете още CodeCombat"
  ...
  signup:
    complete_subscription: "Завършено абониране"
    create_student_header: "Създайте студентски акаунт"
    create_teacher_header: "Създайте учителкси акаунт"
    create_individual_header: "Създайте индивидуален акаунт"
    email_announcements: "Получавай анонси по имейл"
    sign_in_to_continue: "Влезте или създайте акаунт за да продължите"
    teacher_email_announcements: "Дръжте ме в течение за нови ресурси за учители, учебни програми и курсове!"
    creating: "Създаване на профил..."
    sign_up: "Регистриране"
    log_in: "Вход с парола"
    required: "Трабва да влезеш, преди да продължиш."
    login_switch: "Вече имаш акаунт?"
    optional: "по избор"
    connected_gplus_header: "Вие успешно се свързахте с Google+!"
    connected_gplus_p: "Завършете регистрацията, за да влезете в профила си в Google+."
    connected_facebook_header: "Вие успешно се свързахте с Facebook!"
    connected_facebook_p: "Завършете регистрацията, за да влезете в профила си в Facebook."
    hey_students: "Студенти, въведете кода на класа от вашия учител."
    birthday: "Рожден Ден"
    parent_email_blurb: "Знаем, че не можете да чакате да учите програмиране; ние също сме развълнувани! Родителите ви ще получат имейл с допълнителни указания как да създадете профил за вас. Изпратете имейл {{email_link}}, ако имате някакви въпроси."
    classroom_not_found: "Няма класове с този Клас Код. Проверете правописа си или помолете учителя си за помощ!"
    checking: "Проверка..."
    account_exists: "Този имейл вече се използва:"
    sign_in: "Влез"
    email_good: "Имейла изглежда наред!"
    name_taken: "Потребителското име вече е заето! Опитай {{suggestedName}}?"
    name_available: "Достъпно име!"
    name_is_email: "Потребителското име може да не е имейл"
    choose_type: "Изберете типа на профила си:"
    teacher_type_1: "Преподавайте програмиране с помощта на CodeCombat!"
    teacher_type_2: "Настройте своя клас"
    teacher_type_3: "Достъп до ръководствата за курсове"
    teacher_type_4: "Вижте напредъка на учениците"
    signup_as_teacher: "Регистрация като учител"
    student_type_1: "Научете се да програмирате, докато играете завладяваща игра!"
    student_type_2: "Играйте с Вашия клас"
    student_type_3: "Състезавайте се в арени"
    student_type_4: "Изберете Вашия герой!"
    student_type_5: "Подгответе своя Клас код!"
    signup_as_student: "Регистрация като студент"
    individuals_or_parents: "Индивидуално или Родители"
    individual_type: "За играчи, които се учат да кодират извън клас. Родителите трябва да се регистрират тук."
    signup_as_individual: "Регистрация като индивидуален"
    enter_class_code: "Въведете своя клас Код"
    enter_birthdate: "Въведете Вашата дата на раждане:"
    parent_use_birthdate: "Родители, използвайте Вашата дата на раждане."
    ask_teacher_1: "Попитайте Вашия учител за Вашия Клас Код."
    ask_teacher_2: "Не сте част от клас? Създайте "
    ask_teacher_3: "Индивидуален акаунт"
    ask_teacher_4: "вместо."
    about_to_join: "На път сте да се присъедините:"
    enter_parent_email: "Въведете имейл адреса на родителите си:"
    parent_email_error: "Нещо се обърка, когато се опитвате да изпратите имейла. Проверете имейл адреса и опитайте отново."
    parent_email_sent: "Изпратихме имейл с допълнителни указания как да създадете профил. Помолете родителите си да провери входящата си поща."
    account_created: "Акаунтът е създаден!"
    confirm_student_blurb: "Запишете информацията си така, че да не я забравяте. Вашият учител също може да ви помогне да възстановите паролата си по всяко време."
    confirm_individual_blurb: "Запишете информацията за вход в случай, че имате нужда от нея по-късно. Потвърдете имейла си, за да можете да възстановите профила си, ако някога забравите паролата си - проверете входящата си поща!"
    write_this_down: "Запишете си го:"
    start_playing: "Започнете да играете!"
    sso_connected: "Успешно свързан с:"
    select_your_starting_hero: "Изберете Вашия начален герой:"
    you_can_always_change_your_hero_later: "Винаги можете да промените героя си по-късно."
    finish: "Завършихте"
    teacher_ready_to_create_class: "Вие сте готов да създадете своя първи клас!"
    teacher_students_can_start_now: "Вашите ученици ще могат веднага да започнат да играят на първия курс 'Въведение в компютърните науки'."
    teacher_list_create_class: "На следващия екран ще можете да създадете нов клас."
    teacher_list_add_students: "Добавете ученици към класа, като кликнете върху връзката (Преглед на класа), след което изпращате на учениците си класовия код или URL адреса. Можете също така да ги поканите по имейл, ако имат имейл адреси."
    teacher_list_resource_hub_1: "Разгледайте"
    teacher_list_resource_hub_2: "Ръководства за курсове"
    teacher_list_resource_hub_3: "решения на всички нива, както и"
    teacher_list_resource_hub_4: "Ресурсен център"
    teacher_list_resource_hub_5: "за учебни програми, дейности и др!"
    teacher_additional_questions: "Това е! Ако имате нужда от допълнителна помощ или имате въпроси, свържете се с e-mail за поддръжка."
    dont_use_our_email_silly: "Не поставяйте нашия имейл тук! Поставете имейла на родителя си."
    want_codecombat_in_school: "Искате ли да играете CodeCombat през цялото време?"
  ...
  play_level:
    ...
    edit_level: "Редактиране на нивото"
    keep_learning: "Продължи да учиш"
    explore_codecombat: "Разгледайте CodeCombat"
    finished_hoc: "Приключих с моя Час на код"
    get_certificate: "Получете сертификата си!"
    level_complete: "Завършено ниво"
    completed_level: "Завършено ниво:"
    course: "Курс:"
    done: "Готово"
    next_level: "Следващо ниво"
    combo_challenge: "Комбо предизвикателство"
    concept_challenge: "Концепция Предизвикателство"
    challenge_unlocked: "Предизвикателството е отключено"
    combo_challenge_unlocked: "Комбо предизвикателството е отключено"
    concept_challenge_unlocked: "Концепцията предизвикателство е отключена"
    concept_challenge_complete: "Предизвикателството на концепцията е завършено!"
    combo_challenge_complete: "Комбо предизвикателството завършено!"
    combo_challenge_complete_body: "Страхотна работа, изглежда, че сте на път да разберете концепцията!"
    replay_level: "Повтори нивото"
    combo_concepts_used: "__завършено__/__общо__ Използвани концепции"
    combo_all_concepts_used: "Използвахте всички възможни концепции, за да разрешите предизвикателството. Добра работа!"
    combo_not_all_concepts_used: "Вие използвахте завършените от всички възможни концепции за разрешаване на предизвикателството. Опитайте се да получите всички общи понятия следващия път!"
    start_challenge: "Стартирайте предизвикателството"
    next_game: "Следваща игра"
    languages: "Езици"
    programming_language: "Програмни езици"
    show_menu: "Показване на менюто за игри"
    ...
    goals: "Цели"
    goal: "Цел"
    challenge_level_goals: "Целите на ниво за предизвикателство"
    challenge_level_goal: "Цел на ниво предизвикателство"
    concept_challenge_goals: "Концепция, Предизвикателство, Цели"
    combo_challenge_goals: "Целите на ниво предизвикателство"
    concept_challenge_goal: "Концепция, Предизвикателство, Цел"
    combo_challenge_goal: "Цел на ниво предизвикателство"
    ...
    victory_no_progress_for_teachers: "За учителите не е постигнат напредък. Но можете да добавите студентска сметка в класната стая за себе си."
    ...
    hints: "Съвети"
    hints_title: "Съвет {{номер}}"
    code_saved: "Кодът е записан"
    skip_tutorial: "Пропусни (esc)"
    keyboard_shortcuts: "Клавишни комбинации"
    loading_start: "Стартирай Ниво"
    loading_start_combo: "Стартирайте комбо предизвикателството"
    loading_start_concept: "Стартирайте предизвикателство на концепцията"
    ...
    tip_solve_then_write: "Първо, решете проблема. След това напишете кода. Джон Джонсън"
    tip_compiler_ignores_comments: "Понякога мисля, че компилаторът игнорира моите коментари."
    tip_understand_recursion: "Единственият начин да разберете рекурсията е да разберете рекурсията."
    tip_life_and_polymorphism: "Open Source е като напълно полиморфна разнородна структура: Всички видове са добре дошли."
    tip_mistakes_proof_of_trying: "Грешките във вашия код са само доказателство, че се опитвате."
    tip_adding_orgres: "Заоблени великани."
    tip_sharpening_swords: "Заточване на мечовете."
    tip_ratatouille: "Не трябва да позволявате на никого да определят Вашите граници заради това, откъде идвате. Единствената ви граница е Вашата душа. - Густау, Рататуйл"
    tip_nemo: "Когато животът те повали, и се чудиш какво трябва да направиш? Просто плувай, просто плувай. - Дори, Търсенето на Немо"
    tip_internet_weather: "Просто се пренеси в интернет, тук е страхотно. Ние живеем вътре, където времето винаги е страхотно. - Джон Грийн"
#    tip_nerds: "Умниците имат право да обичат неща, като например да скочат нагоре и надолу в стола, да не могат да контролират себе си. - Джон Грийн"
    tip_self_taught: "Аз се научих на 90% от това, което научих. И това е нормално! - Ханк Грийн"
    tip_luna_lovegood: "Не се притеснявайте, Вие сте точно толкова нормален, колкото съм и аз. - Луна Лъвгуд"
    tip_good_idea: "Най-добрият начин да имате добра идея е да имате много идеи. - Линус Полинг"
    tip_programming_not_about_computers: "Компютърните науки не са нищо повече от компютри, отколкото астрономията около телескопа. - Едсгер Дийкстра"
    tip_mulan: "Повярвай, че можеш и ще успееш. - Мулан"
    project_complete: "Проектът е завършен!"
    share_this_project: "Споделете този проект с приятели или семейството:"
    ready_to_share: "Готови ли сте да публикувате вашия проект??"
#    click_publish: "Натисни \"Публикуване\" to make it appear in the class gallery, then check out what your classmates built! You can come back and continue to work on this project. Any further changes will automatically be saved and shared with your classmates."
    already_published_prefix: "Промените ви са публикувани в галерията за класове."
    already_published_suffix: "Продължете да експериментирате и направете този проект още по-добър или вижте какво е построил останалата част от класа ви! Промените ви автоматично ще бъдат запазени и споделени с вашите съученици."
    view_gallery: "Преглед на галерията"
    project_published_noty: "Вашето ниво е публикувано!"
    keep_editing: "Продължете да редактирате"
...
apis:
  ...
  amazon_hoc:
    title: "Продължавайте да учите с Amazon!"
    congrats: "Поздравления за завладяването на предизвикателния час на Кода!"
    educate_1: "Сега продължавайте да научавате за кодиране и изчислителни облаци с AWS Educate, вълнуваща безплатна програма от Amazon както за студенти, така и за учители. С AWS Educate можете да спечелите страхотни значки, когато научите за основите на облака и най-модерните технологии като игри, виртуална реалност и Alexa."
    educate_2: "Научете повече и се регистрирайте тук"
    future_eng_1: "Можете също така да се опитате да изградите свой собствен учебен материал за Alexa"
    future_eng_2: "тук"
    future_eng_3: "(устройство не се изисква). Тази дейност на Алекса е представена от вас"
    future_eng_4: "Amazon бъдещ инженер"
    future_eng_5: "Програма, която създава възможности за обучение и работа за всички K-12 студенти в Съединените щати, които желаят да упражняват компютърни науки."

  play_game_dev_level:
    created_by: "Създаден от {{име}}"
    created_during_hoc: "Създаден по време на часа на кода"
    restart: "Рестартирай нивото"
    play: "Ниво на игра"
    play_more_codecombat: "Играйте още CodeCombat"
    default_student_instructions: "Кликнете, за да контролирате героя си и да спечелите играта!"
    goal_survive: "Да оцелееш."
    goal_survive_time: "Оцеляване за __ секунди __ секунди."
    goal_defeat: "Порази всички врагове."
    goal_defeat_amount: "Поражение __ размер __ врагове."
    goal_move: "Преминете всички червени X марки."
    goal_collect: "Съберете всички елементи."
    goal_collect_amount: "Съберете елементите от стойността."
  ...
  leaderboard:
    ...
    survival_time: "Оцелял"
    defeated: "Победени врагове"
    code_length: "Линии на кода"
    score_display: "__резултат тип__: __резултат__"
  ...
  inventory:
    ...
    equip: "Облечи"
    unequip: "Съблечи"
    warrior_only: "Само войн"
    ranger_only: "Само рейнджър"
    wizard_only: "Само магьосник"
  ...
  buy_gems:
    ...
    retrying: "Грешка в сървъра, пробвай отново."
    ...
    price: "x{{gems}} / месец"
    buy_premium: "Купи премия"
    purchase: "Покупка"
    purchased: "Закупенo"

  earn_gems:
    prompt_title: "Не са достатъчни скъпоценни камъни"
    prompt_body: "Продължете да играете, за да печелите повече!"

  subscribe:
    best_deal: "Най-добра оферта!"
    confirmation: "Поздравления! Сега имате абонамент Premium CodeCombat!"
    premium_already_subscribed: "Вече сте абонирани за Premium!"
    ...
    free_subscription: "Безплатен абонамент"
    ...
    feature_level_access: "Достъп до 300+ нива"
    feature_heroes: "Отключете изключителни герои и домашни любимци"
    feature_learn: "Научете се да правите игри и уеб сайтове"
    month_price: "$__цена__"
    first_month_price: "Само $ __ цена__ за първия месец!"
    lifetime: "Достъп през целия живот"
    lifetime_price: "$__цена__"
    year_subscription: "Годишен абонамент"
    year_price: "$__цена__/година"
    support_part1: "Нуждаете се от помощ при плащане или предпочитате PayPal? Имейл"
